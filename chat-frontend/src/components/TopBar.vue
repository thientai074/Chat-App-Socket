  ...
  <div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
            ...
            <a href="" class="flex items-center mt-2">
              <div class="w-8 h-8 image-fit">
                <img
                  ...
                  class="rounded-full"
                  src="distFront/images/profile-9.jpg"
                />
              </div>
            ...
            <a href="" class="flex items-center mt-2">
              <div class="w-8 h-8 image-fit">
                <img
                  alt="Midone - HTML Admin Template"
                  class="rounded-full"
                  src="distFront/images/profile-10.jpg"
                />
              </div>
            ...
            <a href="" class="flex items-center mt-2">
              <div class="w-8 h-8 image-fit">
                <img
                  alt="Midone - HTML Admin Template"
                  class="rounded-full"
                  src="distFront/images/profile-6.jpg"
                />
              </div>
              <div class="ml-3">Russell Crowe</div>
              <div
          ...
          <a href="" class="flex items-center mt-2">
            <div class="w-8 h-8 image-fit">
              <img
                alt="Midone - HTML Admin Template"
                class="rounded-full"
                src="distFront/images/preview-3.jpg"
              />
            </div>
          ...
          <a href="" class="flex items-center mt-2">
            <div class="w-8 h-8 image-fit">
              <img
                alt="Midone - HTML Admin Template"
                class="rounded-full"
                src="distFront/images/preview-12.jpg"
              />
            </div>
          ...
          <a href="" class="flex items-center mt-2">
            <div class="w-8 h-8 image-fit">
              <img
                alt="Midone - HTML Admin Template"
                class="rounded-full"
                src="distFront/images/preview-2.jpg"
              />
            </div>
            <div class="ml-3">Sony A7 III</div>
            <div
          ...
          <div class="cursor-pointer relative flex items-center mt-5">
            <div class="w-12 h-12 flex-none image-fit mr-1">
              <img
                alt="Midone - HTML Admin Template"
                class="rounded-full"
                src="distFront/images/profile-14.jpg"
              />
              <div
                class="w-3 h-3 bg-success absolute right-0 bottom-0 rounded-full border-2 border-white dark:border-darkmode-600"
              ></div>
    ...
    <div class="intro-x dropdown w-8 h-8">
      ...
      >
        <img
          alt="Midone - HTML Admin Template"
          src="distFront/images/profile-4.jpg"
        />
      </div>
